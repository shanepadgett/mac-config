...

{
  ...
  home.file = {
    ...
    ".config/ghostty/config".source = lib.file.mkOutOfStoreSymlink ./tools/ghostty/config;
    ".config/direnv/direnv.toml".source = lib.file.mkOutOfStoreSymlink ./tools/direnv/direnv.toml;
    ".config/claude/settings.json".source = lib.file.mkOutOfStoreSymlink ./tools/claude/settings.json;
    ".config/claude/mcp.json".source = lib.file.mkOutOfStoreSymlink ./tools/claude/mcp.json;
    ".config/zoxide/config.toml".source = lib.file.mkOutOfStoreSymlink ./tools/zoxide/config.toml;
    ".config/zed/settings.json".source = lib.file.mkOutOfStoreSymlink ./tools/zed/settings.json;
    ".gitconfig".source = lib.file.mkOutOfStoreSymlink ./tools/gitconfig;

    # Shell configs (editable - direct symlinks to repo)
    ".aliases".source = lib.file.mkOutOfStoreSymlink ./shell/aliases;
    ".bashrc".source = lib.file.mkOutOfStoreSymlink ./shell/bashrc;
    ".zshrc".source = lib.file.mkOutOfStoreSymlink ./shell/zshrc;
    ".exports".source = lib.file.mkOutOfStoreSymlink ./shell/exports;
  };
